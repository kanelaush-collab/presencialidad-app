...
if "supervisor_sel" not in st.session_state:
    st.session_state.supervisor_sel = None
...
if st.session_state.usuario is None:
    ...
    if st.session_state.es_supervisor:
        ...
        if not df_reg.empty and not df_usr.empty:
            # Filtrar empleados del supervisor
    ...
    # --- VISTA EMPLEADO ---
        ...
        c2.metric("Objetivo 40%", objetivo)
        c3.metric("Días registrados", len(dias_registrados))
